...
class BarberBookingTemplateTest(TestCase):
    ...
    def test_barber_booking_template_renders(self):
        context = {
            'barberinfo': [
                {'title': 'Barber 1', 'description': 'Description 1', 'image': 'image1.jpg', 'created_on': '2025-02-14'},
                {'title': 'Barber 2', 'description': 'Description 2', 'image': 'image2.jpg', 'created_on': '2025-02-13'},
            ],
            'servicedescription': [
                {'title': 'Haircut', 'services': 'Basic haircut service', 'image': 'service1.jpg', 'created_on': '2025-02-14'},
                {'title': 'Shave', 'services': 'Shaving service', 'image': 'service2.jpg', 'created_on': '2025-02-12'},
            ],
        }
    ...
    def test_updated_on_date_displayed(self):
        context = {
            'barberinfo': [{'title': 'Barber 1', 'description': 'Description', 'image': 'image1.jpg', 'created_on': '2025-02-14'}],
            'servicedescription': [{'title': 'Shampoo', 'services': 'Shampoo service', 'image': 'service1.jpg', 'created_on': '2025-02-15'}],
        }
