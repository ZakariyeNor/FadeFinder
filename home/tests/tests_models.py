...
class BarberInfoModelTest(TestCase):
    ...
    def test_barberinfo_creation(self):
        ...
        self.assertEqual(barber.description, "A description for the test barber.")
...
class ServicesDesModelTest(TestCase):
    ...
    def test_servicesdes_creation(self):
        ...
        service = ServicesDes.objects.create(
            ...
            services="A detailed description of the haircut service offered by the barber.",
            created_on=timezone.now(),
            updated_on=timezone.now()
        )
        ...
        self.assertEqual(service.services, "A detailed description of the haircut service offered by the barber.")
    ...
    def test_servicesdes_default_image(self):
        ...
        service = ServicesDes.objects.create(
            ...
            services="A detailed description of the shaving service offered by the barber.",
            created_on=timezone.now(),
            updated_on=timezone.now()
        )
